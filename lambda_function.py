    ...
    if age is not None:
        ...
        if age <= 0:
            return build_validation_result(
                False,
                "age",
                "You should be older than 0 years old to use this service, "
            ...
            return build_validation_result(
                False,
                "age",
                "You should maximum be 65 years old to use this service, "
                "please provide a different age.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # YOUR CODE GOES HERE!
    # Explicitly parse risk_level as string and make it uppercase
    ...
    # Respond based on the data that was provided
    if risk_level == "NONE":
